<?php 
	...
	DESCRIPTION: Receive an accession number and eXist-db collection name in parameters and delete from Numishare:
	...
	************************/
	...
	if (file_exists($eXist_config_path)) {
	    ...
	    if (strlen($accnum) > 0 && strlen($collection) > 0){
	        ...
	        echo "No access or collection parameter specified.\n";
	    }
	} 
